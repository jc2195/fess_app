...
// like interactivity and animations when the page is inactive
  Widget get page {
    return Visibility(
      ...
      visible: _index == HomeScreenState.currentTab,
...
// ),
// BottomNavigationBarItem(
// icon: Icon(Icons.apartment, size: 30, color: Colors.black,),
// label: '',
// ),
// BottomNavigationBarItem(
// icon: PencilIcon(),
...
// ),
// BottomNavigationBarItem(
// icon: Icon(Icons.chat_bubble_outline, size: 30, color: Colors.black,),
// label: '',
// ),
// BottomNavigationBarItem(
